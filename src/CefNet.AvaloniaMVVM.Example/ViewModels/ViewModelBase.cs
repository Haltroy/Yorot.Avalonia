...
#pragma warning disable CA1822 // Mark members as static
    public Avalonia.Media.IBrush BackColor { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.BackColor.ToHex() : Yorot.DefaultThemes.YorotLight(null).BackColor.ToHex()); }
    public Avalonia.Media.IBrush BackColor2 { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.BackColor2.ToHex() : Yorot.DefaultThemes.YorotLight(null).BackColor2.ToHex()); }
    public Avalonia.Media.IBrush BackColor3 { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.BackColor3.ToHex() : Yorot.DefaultThemes.YorotLight(null).BackColor3.ToHex()); }
    public Avalonia.Media.IBrush BackColor4 { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.BackColor4.ToHex() : Yorot.DefaultThemes.YorotLight(null).BackColor4.ToHex()); }
    public Avalonia.Media.IBrush ForeColor { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.ForeColor.ToHex() : Yorot.DefaultThemes.YorotLight(null).ForeColor.ToHex()); }
    public Avalonia.Media.IBrush OverlayColor { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.OverlayColor.ToHex() : Yorot.DefaultThemes.YorotLight(null).OverlayColor.ToHex()); }
    public Avalonia.Media.IBrush OverlayColor2 { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.OverlayColor2.ToHex() : Yorot.DefaultThemes.YorotLight(null).OverlayColor2.ToHex()); }
    public Avalonia.Media.IBrush OverlayColor3 { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.OverlayColor3.ToHex() : Yorot.DefaultThemes.YorotLight(null).OverlayColor3.ToHex()); }
    public Avalonia.Media.IBrush OverlayColor4 { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.OverlayColor4.ToHex() : Yorot.DefaultThemes.YorotLight(null).OverlayColor4.ToHex()); }

    public Avalonia.Media.IBrush ArtColor { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.ArtColor.ToHex() : Yorot.DefaultThemes.YorotLight(null).ArtColor.ToHex()); }

    public Avalonia.Media.IBrush ArtColor2 { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.ArtColor2.ToHex() : Yorot.DefaultThemes.YorotLight(null).ArtColor2.ToHex()); }
    public Avalonia.Media.IBrush ArtColor3 { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.ArtColor3.ToHex() : Yorot.DefaultThemes.YorotLight(null).ArtColor3.ToHex()); }
    public Avalonia.Media.IBrush ArtColor4 { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.ArtColor4.ToHex() : Yorot.DefaultThemes.YorotLight(null).ArtColor4.ToHex()); }
    public Avalonia.Media.IBrush OverlayForeColor { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.OverlayForeColor.ToHex() : Yorot.DefaultThemes.YorotLight(null).OverlayForeColor.ToHex()); }
    public Avalonia.Media.IBrush ArtForeColor { get => Avalonia.Media.Brush.Parse(YorotGlobal.Main != null ? YorotGlobal.Main.CurrentTheme.ArtForeColor.ToHex() : Yorot.DefaultThemes.YorotLight(null).ArtForeColor.ToHex()); }
